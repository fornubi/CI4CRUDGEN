...
<div class="card">
    <div class="card-header">
        <div class="row">
            ...
            <div class="col-2">
                <button type="button" class="btn float-right btn-success" onclick="save()"
                    title="<?= lang("App.new") ?>"> <i class="fa fa-plus"></i> <?= lang('App.new') ?></button>
            </div>
        </div>
    </div>
    <!-- /.card-header -->
                ...
                success: function(response) {
                    if (response.success === true) {
                        Swal.fire({
                            ...
                            $('#data_table').DataTable().ajax.reload(null, false).draw(
                                false);
                            ...
                            $.each(response.messages, function(index, value) {
                                ...
                                ele.closest('.form-control')
                                    ...
                                    .addClass(value.length > 0 ? 'is-invalid' :
                                        'is-valid');
                                ele.after('<div class="invalid-feedback">' + response
                                    .messages[index] + '</div>');
                            });
                        } else {
                            Swal.fire({
